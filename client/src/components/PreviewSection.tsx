...
export default function PreviewSection() {
  ...
  const netherImages: ImageItem[] = [
    {
      src: "/images/Screenshot_20250325_225714_Minecraft.jpg",
